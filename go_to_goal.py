    ...
    while True:
        ...
        if localized:
            ...
            if not localized:
                ...
                # rand2 = np.random.randint(low = -10, high = 10)
                # await robot.drive_straight(cozmo.util.distance_mm(rand2), cozmo.util.speed_mmps(10)).wait_for_completed()
                # await robot.turn_in_place(cozmo.util.degrees(rand)).wait_for_completed()
                # await robot.drive_straight(cozmo.util.distance_mm(-30), cozmo.util.speed_mmps(10)).wait_for_completed()
